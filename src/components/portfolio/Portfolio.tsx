      ...
      <div className="row">
        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6">
          <div className="fondo-port">
            ...
            <a href="https://www.msintegraciones.com.ve/">
              M & S Integraciones
            </a>
            <a href="http://www.remet.cl/">Remet</a>
            <a href="https://www.longfafans.com/">Lonfar</a>
            <h3>
              04<strong>/05</strong>
            </h3>
          </div>
